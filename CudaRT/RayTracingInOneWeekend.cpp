...
inline shared_ptr<hittable_list> box(const point3& a, const point3& b, shared_ptr<material> mat) {
	...
	sides->add(make_shared<quad>(point3(min.x(), min.y(), min.z()), dx, dy, mat)); // front
	sides->add(make_shared<quad>(point3(max.x(), min.y(), max.z()), -dz, dy, mat)); // right
	sides->add(make_shared<quad>(point3(max.x(), min.y(), max.z()), -dx, dy, mat)); // back
...
void cornell_smoke() {
	...
	world.add(make_shared<constant_medium>(box2, 0.05, color(1, 1, 1)));
